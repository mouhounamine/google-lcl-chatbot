...
const PanelChat = ({ prompts }: { prompts: string[] }) => {
  ...
  const sendPrompt = async (prompt: string) => {
    try {
      const accessToken =
        "ya29.a0AcM612wMA8WOGVxcySPuwxkWpElBaVmTW1r04V036r57ZAZBqKMCl2-MbaL-IjJr3-V7lINMpJpkJFcj7CXhaTHro8BWDq6BXUPimtGP_xCGB5oPpFV5y0VYBQTjZXQ40UGB1GEws1sO-TooP-xbhNpUUGK3lpWt09YaCgYKAU4SARISFQHGX2MinTyqrhzEwnc7FU_w5mXqFg0170"; // Remplace par ton token
